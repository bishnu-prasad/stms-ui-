...
export default function PlatformUsersPage() {
  const kpis = (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      <KPICard title="Platform Users" value="24 Admins" status="Across 4 Roles" delay={0.05} />
      <KPICard title="MFA Enforcement" value="100%" status="Zero unauthenticated logins" delay={0.1} />
      <KPICard title="Active Sessions" value="12 Sessions" status="Currently authenticated" delay={0.15} />
      <KPICard title="Security Rating" value="SOC2 Met" status="Quarterly audit cleared" delay={0.2} />
    </div>
  );

  const charts = (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <ChartCard title="Admin Activity & Access Stream" subtitle="How many administrative actions were performed per role tier this week?" delay={0.25}>
  ...
  const recommendations = [
    {
      title: "Optimize Platform Administrators & Access Control Operational Parameters",
