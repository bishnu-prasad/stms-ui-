...
export default function AuditLogsPage() {
  const kpis = (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      <KPICard title="Audit Trail Count" value="1.2M Logs" status="Retention 365 days" delay={0.05} />
      <KPICard title="Integrity Verification" value="100%" status="Cryptographically signed" delay={0.1} />
      <KPICard title="SOC2 Compliance" value="Passed" status="Audit certified" delay={0.15} />
      <KPICard title="Security Events" value="24 Today" status="Automated IP blocks" delay={0.2} />
    </div>
  );

  const charts = (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <ChartCard title="Daily Administrative Audit Events" subtitle="What is the volume of administrative actions recorded per hour?" delay={0.25}>
  ...
  const recommendations = [
    {
      title: "Optimize Security Audit & Compliance Logs Operational Parameters",
