...
export default function CustomersPage() {
  const kpis = (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      <KPICard title="Total Customers" value="142 Tenants" status="+4 this month" delay={0.05} />
      <KPICard title="Avg Customer Health" value="99.2%" status="SLA compliance" delay={0.1} />
      <KPICard title="Active Sites Portfolio" value="5,570 Sites" status="Nationwide coverage" delay={0.15} />
      <KPICard title="Expiring Licenses" value="2 Accounts" status="Action required in 7 days" delay={0.2} />
    </div>
  );

  const charts = (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <ChartCard title="Customer Account Footprint & Site Growth" subtitle="Which enterprise customer tenant expanded their site monitoring allocation most rapidly?" delay={0.25}>
  ...
  const recommendations = [
    {
      title: "Optimize Enterprise Customer Tenant Management Operational Parameters",
