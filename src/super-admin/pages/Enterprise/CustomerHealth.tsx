...
export default function CustomerHealthPage() {
  const kpis = (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      <KPICard title="Average Health" value="99.2%" status="Across all 142 tenants" delay={0.05} />
      <KPICard title="Healthy Tenants" value="140 Accounts" status=">98% Health score" delay={0.1} />
      <KPICard title="At-Risk Tenants" value="2 Accounts" status="Under observation" delay={0.15} />
      <KPICard title="SLA SLA Met" value="100%" status="Zero contract breaches" delay={0.2} />
    </div>
  );

  const charts = (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <ChartCard title="Tenant Health Score Distribution" subtitle="How many customer tenants are operating at 99%+ operational health?" delay={0.25}>
  ...
  const recommendations = [
    {
      title: "Optimize Customer Health Score & SLA Monitoring Operational Parameters",
