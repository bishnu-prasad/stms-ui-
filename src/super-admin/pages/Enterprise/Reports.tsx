...
export default function ReportsPage() {
  const kpis = (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      <KPICard title="Reports Generated" value="142" status="This month" delay={0.05} />
      <KPICard title="Scheduled Exports" value="24 Daily" status="Automated PDFs" delay={0.1} />
      <KPICard title="Compliance Ready" value="ISO 27001" status="SOC2 Type II" delay={0.15} />
      <KPICard title="Data Precision" value="100%" status="Audited financial stats" delay={0.2} />
    </div>
  );

  const charts = (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <ChartCard title="Monthly Report Exports by Type" subtitle="Which report categories are requested most frequently by enterprise executives?" delay={0.25}>
  ...
  const recommendations = [
    {
      title: "Optimize Enterprise Platform Reporting Suite Operational Parameters",
