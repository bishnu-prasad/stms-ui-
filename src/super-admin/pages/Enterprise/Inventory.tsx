...
export default function InventoryPage() {
  const kpis = (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      <KPICard title="Monitored Assets" value="22,280" status="SMPS, SPS, Batteries, DG" delay={0.05} />
      <KPICard title="Asset Health Rate" value="97.8%" status="Fully operational" delay={0.1} />
      <KPICard title="Replacement Parts" value="93 Units" status="In service bases" delay={0.15} />
      <KPICard title="Asset Valuation" value="₹184 Cr" status="Managed hardware value" delay={0.2} />
    </div>
  );

  const charts = (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <ChartCard title="Equipment Asset Distribution by Type" subtitle="What proportion of site equipment consists of lithium battery banks vs rectifiers?" delay={0.25}>
  ...
  const recommendations = [
    {
      title: "Optimize Platform Hardware & Component Inventory Operational Parameters",
